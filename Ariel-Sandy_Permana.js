...
console.log(bgcolor(color('Tunggu Bangsat','green','white'))) 
await sleep(1000) 


sock.browserDescription = ["Ariel SP", "Mac", "3.0.0"];
...
require("./worker/Base-Ariel-Sandy-Permana")(sock, m, chatUpdate, store)
} catch (err) {
console.log(err)
}
})
sock.ev.on('group-participants.update', async (update) =>{
   ...
   console.log(update, 'Ariel Sandy Permana')
   })         
// Setting
    sock.decodeJid = (jid) => {
        if (!jid) return jid
